    ...
    @else
        ...
        <a href="{{ route('quotation.sign', ['id' => $work_order['id']]) }}" 
           class="btn btn-info btn-lg">
            <i class="fas fa-signature"></i> Sign Quotation Now
        </a>
    @endif
</div>
```
...
## 3. Add Link to Generate Quotation Button
...
<html>
<head>
    <title>Quotation Ready for Signature</title>
</head>
<body style="font-family: Arial, sans-serif; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto;">
        <h2 style="color: #667eea;">Your Quotation is Ready</h2>
 ...
 * @return object|null
 */
function getQuotationSignature($work_order_id) {
 ...
 * @return bool
 */
function isQuotationSigned($work_order_id) {
    return getQuotationSignature($work_order_id) !== null;
}
```
...
```blade
@if(isQuotationSigned($work_order['id']))
