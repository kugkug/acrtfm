    ...
    $footer = [
        [
            ...
            'attrib' => [
                ...
                'data-trigger' => 'update-work-order',
            ...
            <form>
                ...
                >
                    ...
                    <x-select 
                        ...
                        :label="'Customer'"
                        :selected="$work_order['customer_id']"
                    />
                        ...
                        <div class="col-md-6">
                            <x-input 
                                :attrib="[
                                    ...
                                    'data' => '',
                                    'class' => 'form-control form-control-sm override-input',
                                    'value' => $work_order['estimated_hours'],
                                ]"
                            />
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <x-input 
                                :attrib="[
                                    ...
                                    'data' => '',
                                    'class' => 'form-control form-control-sm override-input',
                                    'value' => $work_order['schedule_date'],
                                ]"
                            />
                        ...
                        <div class="col-md-6">
                            <x-input 
                                :attrib="[
                                    ...
                                    'data' => '',
                                    'class' => 'form-control form-control-sm override-input',
                                    'value' => $work_order['schedule_time'],
                                ]"
                            />
