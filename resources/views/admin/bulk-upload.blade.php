...
<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            ...
            <form action="/execute/ac-bulk-upload" method="POST">
                @method('PUT')
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="name">Model Numbers</label>
                        <textarea class="form-control " placeholder="Model Numbers" style="resize: none;" id="txtModelNos"></textarea>
                    </div>
                    {{--<div class="form-group">
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-primary" id="btn-review-bulk">Proceed to Group Upload</button>
            <button type="button" class="btn btn-danger" id="btn-reset-bulk" >Clear</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
