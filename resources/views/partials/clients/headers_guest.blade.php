...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('adminlte3.2/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light">
            ...
            <div class="container">
                ...
                <a href="/home" class="navbar-brand">
                    <img src="{{ asset('images/logo1.jpg') }}" alt="App LOGO" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    ...
                    <li class="nav-item dropdown">
                      <a class="nav-link text-primary" href="/signup">
                        <i class="fa fa-user-edit"></i> Sign-up
                      </a>
                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li style="width: 100%">
                                    <form class="form-inline ml-0 ml-md-3" action="/execute/client/search-comment"
                                        method="post">
                                        @csrf
