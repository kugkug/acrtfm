...
<script src="{{ asset('assets/system/plugins/jquery-asColorPicker-master/libs/jquery-asColor.js') }}"></script>
...
<script src="{{ asset('assets/acrtfm/js/widgets-init.js') }}"></script>
<script src="{{ asset('assets/acrtfm/js/main-scripts.js') }}"></script>
</body>
</html>